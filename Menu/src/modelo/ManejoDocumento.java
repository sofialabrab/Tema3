...
public class ManejoDocumento {
     ...
     */
    public ManejoDocumento(String name) throws FileNotFoundException
    {
     ...
     * @throws FileNotFoundException Error de archivo no encontrado
     */
    public ManejoDocumento(String ruta,String archivo) throws FileNotFoundException
    {
	...
	public void productos(ArrayList<Producto> listaProductos)throws IOException
	{
		 
		
		FileWriter writer = new FileWriter("inventario_final.txt");
		
		for (Producto p : listaProductos)
		{
			 
			String linea = p.getNombre() + "," + p.getCategoria() + "," + p.getTamaño()+ "," +p.getMarca() + "," + p.getStock() + "," + p.getPrecio();
			writer.write(linea);
		}
		writer.close();
